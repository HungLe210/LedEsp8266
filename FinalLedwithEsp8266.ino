...
const char* password = "Minhhung07";
...
const char WebPage[] =
  "<!DOCTYPE html><style> #header{ min-height: 20px; background-color: #99ccff; } #menu{ min-height: 20px; margin-top: 1%; background-color: #99ccff; } #footer{ min-height: 20px; margin-top: 1%; background-color: #666699; } #header, #menu, #footer{ margin-left: 10%; margin-right: 10%; box-shadow: 3px 5px 7px #666666; border: 1px solid black; } @viewport{ zoom: 1.0; width: extend-to-zoom; } @-ms-viewport{ width: extend-to-zoom; zoom: 1.0; } </style> <html lang='en'> <head> <meta name='viewport' content='width=device-width, initial-scale=1'> <title>ESP8266 Web Server</title> </head> <body> <div id='header'><center><h1>LED MATRIX 32x8 AND ESP8266</H1></center></div>" \
  "<html>" \
  "<head>" \
  "<style>" \
  "label{color:red}"\
  ...
  "<div id='menu'><center><H2>CHAY CHU TREN 4 LED MATRIX</h2></center></div> "\
